...
const OCD = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 2, text: "3-6 hours", isCorrect: false },
      { id: 3, text: "More than 6 hours", isCorrect: false },
    ],
  },
  {
    ...
    options: [
      ...
      { id: 2, text: "Moderate interference", isCorrect: false },
      { id: 3, text: "Severe interference", isCorrect: false },
    ],
  },
  {
    text: " Are you able to control these obsessions or compulsions despite your efforts to stop or ignore them?",
    options: [
      { id: 0, text: "Yes, always", isCorrect: true },
      { id: 1, text: "Yes, sometimes", isCorrect: false },
      { id: 2, text: "No, rarely", isCorrect: false },
      { id: 3, text: "No, never", isCorrect: false },
    ],
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { id: 1, text: "1-6 months", isCorrect: false },
      { id: 2, text: "6 months to 1 year", isCorrect: false },
      { id: 3, text: "More than 1 year", isCorrect: false },
    ],
  },
];
const Phobia = [
...
export const SoulCare=[Anxiety,Depression,PanicAttack,OCD,Phobia,Insomnia,Fatique,Autism,BipolarDisorder,Hallucination];
